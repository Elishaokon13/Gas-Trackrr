...
// Add a custom logger function for better visibility in terminal
const logMessage = (type, message, data = null) => {
  ...
  if (data) {
    // Prevent large object logging by limiting output
    const safeData = typeof data === 'object' 
      ? JSON.stringify(data, (key, value) => {
        // Truncate arrays and strings to prevent overwhelming logs
      ...
      : data;
    console.log(`${prefix} DATA:`, safeData);
  }
};
